...
public class EventbriteOAuth2Test extends OAuth2Test {
    ...
    public void itShouldBePossibleToSignUp() {
        ...
        final EventBriteAuthUser authUser = (EventBriteAuthUser) (ServiceUserPlugin.getLastAuthUser());
        assertThat(authUser.getId()).isEqualTo("107949557141");

        final EntryUser user = EntryUser.findByEmail(EVENTBRITE_USER_EMAIL);
