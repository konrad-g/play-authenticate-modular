...
public abstract class OAuth2Test extends WithBrowser {
    ...
    protected FakeApplication provideFakeApplication() {
        ...
        additionalPlugins.add(ServiceUserPlugin.class.getName());
        ...
        return Helpers.fakeApplication(
                ...
                additionalPlugins,
                Collections.singletonList(elements.auth.main.ServiceUserPlugin.class.getName())
        );
    }
    ...
    public static class ServiceUserPlugin extends elements.auth.main.ServiceUserPlugin {
    ...
    public void resetLastAuthUser() {
        ServiceUserPlugin.resetLasAuthUser();
    }
