...
public class GoogleOAuth2Test extends GoogleOAuth2Base {
    ...
    public void itShouldBePossibleToSignUp() {
        ...
        final GoogleAuthUser authUser = (GoogleAuthUser) (ServiceUserPlugin.getLastAuthUser());
        ...
        final EntryUser user = EntryUser.findByEmail(GoogleOAuth2Base.GOOGLE_USER_EMAIL);
