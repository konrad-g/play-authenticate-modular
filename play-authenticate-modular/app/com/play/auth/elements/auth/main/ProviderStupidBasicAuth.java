...
public class ProviderStupidBasicAuth extends BasicAuthProvider {

	@Inject
	public ProviderStupidBasicAuth(Application app) {
		super(app);
	}
	...
	protected Content unauthorized(Context context) {
		...
		return PageAuthLogin.renderLoginContent(Optional.empty()).content;
	}
}
